"""
    Evaluatuon methods for protein structure, includes RMSD:

    RMSD calculate Ca-distance among the whole pdb-files.
"""
import imp
import math
...
class Evaluator:
    ...
    def evaluate(self, emdb_id, predicted_file, gt_file, execution_time):
        ...
        until all pairs with a distance of less than 3A have been removed.
        """
